...
public class PharmacyRegisterDTO {
    ...
    // TODO: Check is location changed on front(pharmacy registration) to this format (country, address, city)
    ...
    @NotEmpty(message = "Dermatologist consultation price  is required.")
    @Numeric(message = "Dermatologist consultation price can only contain numbers.")
    private Double dermatologistConsultationPrice;

    @NotEmpty(message = "Pharmacist consultation price is required.")
    @Numeric(message = "Pharmacist consultation price can only contain numbers.")
    private Double pharmacistConsultationPrice;

    @NotEmpty(message = "Pharmacy administrator is required.")
    ...
    public PharmacyRegisterDTO(@NotEmpty(message = "Name is required.") String name, @NotEmpty(message = "City is required.") String city, @NotEmpty(message = "Address is required.") String address, @NotEmpty(message = "Country is required.") String country, @NotEmpty(message = "Description is required.") @Size(min = 6, message = "Description must have at least 6 characters.") String description, @NotEmpty(message = "Dermatologist consultation price  is required.") Double dermatologistConsultationPrice, @NotEmpty(message = "Pharmacist consultation price is required.") Double pharmacistConsultationPrice, @NotEmpty(message = "Pharmacy administrator is required.") UserRegisterDTO pharmacyAdministrator) {
        this.name = name;
        this.city = city;
