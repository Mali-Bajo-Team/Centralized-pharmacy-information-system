...
public class ConsultationService implements IConsultationService {
    ...
    public List<FreePharmacyReadDTO> allPharmaciesWhichHaveMinOnePharmacistFree(String examinationStartDateString) {
        ...
        for (Pharmacy pharmacy : pharmacyRepository.findAll()) {
            ...
            for(Consultant freePharmacist : consultants){
                pharmacyFreePharmacist.add(new FreePharmacistReadDTO(freePharmacist));
            }

            pharmaciesWithMinOnePharmacistFree.add(new FreePharmacyReadDTO(pharmacy,pharmacyFreePharmacist));
        }
