      ...
      <v-col>
        ...
        <v-row>
          ...
          <div class="ml-4 mb-6 mt-16">
            <h5 class="ml-n primary--text">Choose user for consultation</h5>
            <v-autocomplete
              v-model="model"
              :items="items"
              :loading="isLoading"
        ...
        <v-row>
          ...
          <div class="mr-10 mt-6">
            <h5 class="ml-n primary--text">Choose date for consultation</h5>
            <v-date-picker
              v-model="picker"
          ...
          <!-- CHOOSE END TIME -->
          <div>
            <h5 class="ml-n mt-6 primary--text">
        ...
        <v-row>
          <div class="mt-5">
            ...
            <h5 class="ml-n mt-6 primary--text">Pick vacation date range</h5>
            <v-date-picker
